...
do -- class def
    local EnvVizdoomMultiDuel = torch.class('EnvVizdoomMultiDuel')

    -- main interface
    function EnvVizdoomMultiDuel:__init(opt)
    ...
    function EnvVizdoomMultiDuel:start()
    ...
    function EnvVizdoomMultiDuel:getState()
        local obs
    ...
    function EnvVizdoomMultiDuel:getReward()
    ...
    function EnvVizdoomMultiDuel:getTerminal()
        local terminal = self.game:isEpisodeFinished()
        return (terminal==true) and 1 or 0
    end

    function EnvVizdoomMultiDuel:takeAction(actionIndex)
    ...
    --
    function EnvVizdoomMultiDuel:training()
        self.isShapingReward = true
    end

    function EnvVizdoomMultiDuel:evaluate()
        self.isShapingReward = false
    end

    -- for reporting
    function EnvVizdoomMultiDuel:tostring()
        local str = ''
    ...
    -- helpers
    function EnvVizdoomMultiDuel:convertScreen(screenBuffer)
    ...
    function EnvVizdoomMultiDuel:createNullScreen()
...
local function create(opt)
    return EnvVizdoomMultiDuel(opt)
end
return create