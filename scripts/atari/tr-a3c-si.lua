...
dofile('train-async.lua'){
    ...
    gcFreq = 3456,
    -- other: save & load
    saveParamsPath = 'save/atari-a3c/si-params.t7',
    saveBestValParamsPath = 'save/atari-a3c/best-si-params.t7',
    saveValMetersPath = 'save/atari-a3c/si-val-meters.t7',
    logPath = 'save/atari-a3c/si-log',
}