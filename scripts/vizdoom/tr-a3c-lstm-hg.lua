...
dofile('train-async.lua'){
    ...
    gcFreq = 3456,
    -- other: save & load
    saveParamsPath = 'save/vizdoom-a3c-lstm/hg-params.t7',
    saveBestValParamsPath = 'save/vizdoom-a3c-lstm/best-hg-params.t7',
    saveValMetersPath = 'save/vizdoom-a3c-lstm/hg-val-meters.t7',
    logPath = 'save/vizdoom-a3c-lstm/hg-log',
}