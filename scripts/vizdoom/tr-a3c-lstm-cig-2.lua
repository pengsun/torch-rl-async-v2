...
local nCombo = 1
local nActions = 7
local learningMaxSteps = 320*1000*1000
...
dofile('train-async.lua'){
    ...
    gcFreq = 3456,
    -- other: save & load
    saveParamsPath = 'save/vizdoom-a3c-lstm-T320M/cig-params.t7',
    saveBestValParamsPath = 'save/vizdoom-a3c-lstm-T320M/best-cig-params.t7',
    saveValMetersPath = 'save/vizdoom-a3c-lstm-T320M/cig-val-meters.t7',
    logPath = 'save/vizdoom-a3c-lstm-T320M/cig-log',
}