...
dofile('train-async.lua'){
    ...
    gcFreq = 3456,
    -- other: save & load
    saveParamsPath = 'save/vizdoom-a3c-rgb-T320M/cig-params.t7',
    saveBestValParamsPath = 'save/vizdoom-a3c-rgb-T320M/best-cig-params.t7',
    saveValMetersPath = 'save/vizdoom-a3c-rgb-T320M/cig-val-meters.t7',
    logPath = 'save/vizdoom-a3c-rgb-T320M/cig-log',
}